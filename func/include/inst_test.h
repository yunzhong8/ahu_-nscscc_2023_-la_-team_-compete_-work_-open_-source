...
#define RLWINM_INST(rd, rj, imm5_a, imm5_b, imm5_c) \
    .word (0x30<<26|0x1<<25|imm5_a<<20|imm5_b<<15|imm5_c<<10|rj<<5|rd)

/* 82 */
#define TEST_RLWINM(in_a, imm5_a, imm5_b, imm5_c, ref) \
    LI (t0, in_a); \
    LI (v1, ref); \
    NOP4; \
    RLWINM_INST(10, 12, imm5_a, imm5_b, imm5_c); \
    NOP4; \
    bne v0, v1, inst_error; \
    NOP4
